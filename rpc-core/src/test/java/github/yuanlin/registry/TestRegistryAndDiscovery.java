...
public class TestRegistryAndDiscovery {
    ...
    public void testZooKeeperRegistryAndDiscovery() {
        ...
        RpcRequest rpcRequest1 = RpcRequest.builder().interfaceName("github.yuanlin.HelloService").build();
        RpcRequest rpcRequest2 = RpcRequest.builder().interfaceName("github.yuanlin.HiService").build();
